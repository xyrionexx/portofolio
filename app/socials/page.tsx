...
export default function Socials() {
  ...
  return (
    <main className="relative min-h-screen bg-black overflow-hidden selection:bg-white selection:text-black">
      ...
      <div className="fixed inset-0 pointer-events-none opacity-20 bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(255,0,0,0.02),rgba(0,255,0,0.01),rgba(0,0,255,0.02))] bg-[length:100%_4px,3px_100%]" />
          ...
          {stage === "loading" && (
            ...
            >
              ...
              <div className="flex flex-col items-center font-mono text-[10px] text-zinc-500 gap-1">
                <motion.span animate={{ opacity: [0, 1, 0] }} transition={{ repeat: Infinity, duration: 0.1 }}>
                ...
                <div className="grid grid-cols-1 gap-4">
                  {[
                    ...
                    >
                      ...
                      <motion.div initial={{ opacity: 0, x: -10 }} whileHover={{ opacity: 1, x: 0 }} className="absolute -left-6 text-white text-xl hidden md:block">
                        ▶
                      </motion.div>
                    </motion.a>
                  ))}
