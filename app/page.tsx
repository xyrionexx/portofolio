    ...
    <main className="relative min-h-screen bg-black overflow-hidden selection:bg-white selection:text-black">
      ...
      {!loading && (
        <>
          ...
          <section
            id="tech"
            className="relative min-h-screen bg-zinc-950 overflow-hidden py-32 px-6 md:px-12"
          >
            <div className="absolute inset-0 z-40 pointer-events-none flex">
              ...
              <motion.div
                ...
                className="absolute left-1/2 top-0 -translate-x-1/2 w-px h-full bg-white z-50 origin-top"
              />
            </div>

            <div className="max-w-7xl mx-auto relative z-10">
              <h2 className="text-6xl md:text-9xl font-black text-white tracking-tighter uppercase leading-none opacity-10 mb-24">
                TECH_OPS
              </h2>
                  ...
                  >
                    <div className="relative aspect-video bg-zinc-900 overflow-hidden border border-zinc-800 group-hover:border-white transition-colors duration-500">
                      <Image
                        ...
                        alt={project.name}
                        fill
                        className="object-cover filter grayscale brightness-50 group-hover:brightness-100 group-hover:scale-105 transition-all duration-700"
                      />
                    ...
                    <div className="mt-6 flex justify-between items-start">
                      <div>
                        <h4 className="text-2xl font-bold text-white tracking-tighter uppercase group-hover:tracking-widest transition-all duration-500">
                          {project.name}
                        </h4>
...
function BGMPlayer() {
  ...
  const toggleAudio = () => {
    ...
    if (playing) {
      ...
      audio.play().catch((e) => {
        console.warn("Audio file missing or not supported yet.");
      });
    }
    setPlaying(!playing);
  };
